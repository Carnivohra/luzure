...
pub(crate) struct RenderExtraction {
...
impl RenderExtraction {
    ...
    pub(crate) fn add_system(&mut self, system: RenderExtractSystem) {
        self.systems.push(system);
    }

    pub(crate) fn run(&mut self, registry: &Registry, scene: &mut RenderScene)
        -> Result<(), RenderError>
    {
